...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
       ...
       echo "<center>" ;
        echo "<h3>enjoy our Mental article concerning the mental health </h3>" ;
        echo   "</center>";
        echo "<p>".$row['id']."";
        echo "<img src='" . $row['image'] . "' alt='Uploaded Image' class='article-image'>";
        echo " <h2> " . $row['title'] . ".</h2>";
        echo "<p><a href='article_mental?id=".$row['id']."' style='color:lightblue;'>Learn more</a><p>";
    ...
    echo "<h1 style='text-align:center;color:black;'>No post found</h1>.";
}
