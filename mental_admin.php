...
if ($result=="") { try {
  $stmt = $pdo->prepare("INSERT INTO mental_post (title,description,introduction,conclusion,image) VALUES (?,?,?,?,?)");
  $stmt->execute([$_POST["title"], $_POST["introduction"], $_POST["description"],$_POST["conclusion"],$targetFilePath]);
