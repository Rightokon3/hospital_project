...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-2">
          <center>  <h1 style="color:white;font-size:69px"><small></small><i>Ascending <span style="color:black;">Information</span>Artice</i></h1></center>
            </div>
 ...
 <div class="team">
    <center>
        <h3>Have access to Information about common conditions, symptoms, and treatments. just enjoy this amazing health artice </h3>
    </center>
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<p><a href='article_information?id=".$row['id']."'>Learn more</a><p>";
