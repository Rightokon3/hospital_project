...
<body>
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-2">
          <center>  <h1 style="color:white;font-size:69px"><small></small><i>Emegrency <span style="color:black;">Tips</span></i></h1></center>
            </div>
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        ...
        echo "<p><a href='display_myemergency?id=".$row['id']."'>Learn more</a><p>";
